...
function loadCurrentSettings() {
    ...
    if (voicePitchSlider && pitchValue) {
        ...
        pitchValue.textContent = settings.voicePitch || 1.0;
    }
...
function testVoiceSettings() {
    ...
    try {
        ...
        let selectedVoice = voices.find(voice => 
            ...
            (genderPref === 'female' && voice.name.toLowerCase().includes('female')) ||
            (genderPref === 'male' && voice.name.toLowerCase().includes('male'))
        );
...
function importSettings() {
    ...
    input.onchange = async (event) => {
        ...
        try {
            ...
            showToast('Failed to import settings', 'error', 3000);
        }
    };
